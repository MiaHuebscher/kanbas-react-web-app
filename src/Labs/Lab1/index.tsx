export default function Lab1() {
    return (
        <div className="container" id="wd-lab1">
            <h2>Lab 1</h2>
            <h3>HTML Examples</h3>
            <div id="wd-h-tag">
                <h4>Heading Tags</h4>
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Pat the tenderloin down to dry and carve out a nice rectangle.</li>
                    <li>Trim off fat and silver skin. Wrap the meat in string, if needed, 
                        to avoid the meat from separating while searing.</li>
                    <li>Heat a skillet to medium-high heat and melt some duck fat.</li> 
                    <li>Place the tenderloin in the skillet and immediately sear off the ends 
                        first for about 1 minute on each end.</li>
                    <li>Finish cooking the four sides of the meat for about 90 seconds each.</li>
                    <li>Add butter to the skillet and baste the meat for about 2 minutes.</li>
                    <li>Once cooked and basted, place the tenderloin on a cooling rack to allow 
                        all sides to cool.</li>
                    <li>When cooled, pat the bottom of the tenderloin dry and place it on a sheet 
                        of rolled-out pastry dough.</li>
                    <li>Preheat the oven to 400 degrees Fahrenheit.</li>
                    <li>Wrap the meat in the farce , then wrap the pastry dough around the meat 
                        using egg yolks to seal it.</li>
                    <li>Polk the dough with a fork to let out the air and prevent too much puff 
                        while baking. Brush the wellington with the rest of the egg yolks.</li>
                    <li>Place the beef wellington in the oven and bake for about 30 to 40 minutes.</li>
                    <li>Let the beef wellington rest for about 10 minutes to allow the juices to settle.</li>
                </ol>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>East of Eden</li>
                    <li>1984</li>
                    <li>Harry Potter and the Prisoner of Askaban</li>
                    <li>The Seven Silly Eaters</li>
                </ul>
            </div>
            <div id="wd-tables">
                <h4>Table Tag</h4>
            ...
            <div id="wd-forms">
                ...
                Please <a id="wd-github" href="https://github.com/MiaHuebscher/kanbas-react-web-app">click here</a> to get to 
                the GitHub repository for the course
            </div>
        </div>
