...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <h4 className="mt-3">Retrieving Arrays</h4>
      ...
      <br /><br />
        ...
        <input type="checkbox" defaultChecked={todo.completed} 
               className="form-check-input float-start me-2 mt-2" id = "wd-checkbox-todo-completed"
               onChange={() => setTodo({...todo, completed: !todo.completed})} />
        <label htmlFor="wd-checkbox-todo-completed" className="form-check-label fs-4 float-start me-2">Completed = {todo.completed.toString()}</label>
