    ...
    return (
      <div className="container">
        ...
        <div id="wd-css-background-colors">
          ...
          <p className="wd-bg-color-red wd-fg-color-black">This background of this 
          paragraph is red but <span className="wd-bg-color-green wd-fg-color-white">
        ...
        <div id="wd-css-paddings">
          <h2>Padding: adds space between
            the element's content and its
            border
          </h2>
        ...
        <div id="wd-css-margins">
          <h2>Margins: add space between 
            the current element's border 
            and the next element's border
          </h2>
          <div
        ...
        <div id="wd-css-position-relative">
          <h2>Relative: positioned relative
        ...
        <div id="wd-css-position-absolute">
          <h2>Absolute: positioned relative to the
            position of its parent (in this case, this heading
            is the parent)
          </h2>
