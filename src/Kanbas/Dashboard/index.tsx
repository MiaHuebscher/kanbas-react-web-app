                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    ...
                                    CS5610 Web Development SEC 01 Summer 1 2024
                                </a>
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    href="#/Kanbas/Courses/1234/Home"
                                    style={{ textDecoration: "none", color: "navy", fontWeight: "bold" }}>
                                    CK2500 Intermediate Cooking SEC 01 Summer 1 2024
                                </a>
                                <p className="wd-dashboard-course-title card-text">
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    href="#/Kanbas/Courses/1234/Home"
                                    style={{ textDecoration: "none", color: "navy", fontWeight: "bold" }}>
                                    SU4500 Advanced Surfing SEC 01 Summer 1 2024
                                </a>
                                <p className="wd-dashboard-course-title card-text">
                                    Advanced Surfing
                                </p>
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    href="#/Kanbas/Courses/1234/Home"
                                    style={{ textDecoration: "none", color: "navy", fontWeight: "bold" }}>
                                    BIOL1111 General Biology SEC 01 Summer 1 2024
                                </a>
                                <p className="wd-dashboard-course-title card-text">
                                    General Biology
                                </p>
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    href="#/Kanbas/Courses/1234/Home"
                                    style={{ textDecoration: "none", color: "navy", fontWeight: "bold" }}>
                                    HK7500 Extreme Hiking SEC 01 Summer 1 2024
                                </a>
                                <p className="wd-dashboard-course-title card-text">
                                    Extreme Hiking
                                </p>
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    href="#/Kanbas/Courses/1234/Home"
                                    style={{ textDecoration: "none", color: "navy", fontWeight: "bold" }}>
                                    GM6000 Advanced German SEC 01 Summer 1 2024
                                </a>
                                <p className="wd-dashboard-course-title card-text">
                                    Advanced German
                                </p>
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <a className="wd-dashboard-course-link"
                                    href="#/Kanbas/Courses/1234/Home"
                                    style={{ textDecoration: "none", color: "navy", fontWeight: "bold" }}>
                                    PM1000 The Art of Pretzel Making SEC 01 Summer 1 2024
                                </a>
                                <p className="wd-dashboard-course-title card-text">
