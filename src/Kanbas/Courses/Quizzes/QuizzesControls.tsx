...
export default function QuizzesControls({qid, cid, updateQuiz} : {qid: any, cid: any, updateQuiz: () => void }) {
    return (
        <div className="wd-grades-controls text-nowrap padding ms-5 me-5">
            ...
            className="btn wd-rounded-corners-all-around btn-lg btn-danger me-1 float-end" onClick={updateQuiz}>
